...
function DisabledRouteCard() {
  return (
    <div
      className="rounded-lg border border-border bg-surface-1 opacity-40 select-none pointer-events-none"
      aria-hidden="true"
    >
      ...
      <div className="px-5 py-5 space-y-4">
        ...
        {/* Disabled button */}
        <div className="h-11 rounded-md bg-surface-3 border border-border flex items-center justify-center gap-2">
          <Clock className="h-4 w-4 text-muted-foreground/40" strokeWidth={1.5} />
          <span className="text-sm text-muted-foreground/40 font-medium">Coming in Phase 2</span>
        </div>
      </div>
    </div>
  )
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            <div className="space-y-4 animate-fade-up stagger-1">
              ...
              <div className="flex items-start gap-3 rounded-md border border-border border-l-4 border-l-border-strong bg-surface-2 px-4 py-3">
                ...
                <div>
                  <p className="text-sm font-medium text-foreground">Phase 2 feature</p>
            ...
            <div className="space-y-6 animate-fade-up stagger-2">
              ...
              <div className="space-y-3">
                {upcomingFeatures.map(feature => (
                  <div
                    key={feature.label}
                    className="flex items-start gap-3 rounded-md border border-border bg-surface-1 px-4 py-3"
                  >
                    <div className="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded bg-surface-3 border border-border">
                      <feature.icon className="h-3.5 w-3.5 text-muted-foreground" strokeWidth={1.5} />
                    </div>
                    <div>
